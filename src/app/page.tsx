...
function StudioBody() {
  return (
    <>
      ...
      <section
        id="showcase"
        className="w-full py-16 sm:py-24 bg-white dark:bg-[#18181b] min-h-screen bg-gradient-to-br from-[#f8fafc] via-[#e0e7ef] to-[#f1f5f9] dark:from-[#18181b] dark:via-[#23272f] dark:to-[#18181b] flex flex-col"
      >
